...
export default function Navbar() {
  ...
  const navLinks = [
    ...
    { label: 'Locations', href: '#stores', icon: '📍', badge: 'Stores' },
    ...
    <nav className={`fixed top-0 left-0 right-0 w-full z-50 transition-all duration-300 ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex justify-between items-center relative">
        ...
        <div className="hidden lg:flex gap-6 items-center">
          ...
          <a 
            href="tel:8370818181" 
            className="bg-slate-900 hover:bg-blue-600 text-white text-[11px] font-bold px-4 py-2 rounded-full transition-all duration-300 shadow-sm hover:shadow-md hover:-translate-y-0.5 flex items-center gap-1.5"
          >
